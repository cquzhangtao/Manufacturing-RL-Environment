...
class DdpgAgent(tf_agent.TFAgent):
  ...
  def __init__(self,
    ...
    policy = actor_policy.ActorPolicy(
        ...
        actor_network=self._actor_network, clip=True,observation_and_action_constraint_splitter=observation_and_action_constraint_splitter)
    collect_policy = actor_policy.ActorPolicy(
        time_step_spec=time_step_spec, action_spec=action_spec,
        actor_network=self._actor_network, clip=False,observation_and_action_constraint_splitter=observation_and_action_constraint_splitter)
