...
import tensorflow_probability.python.util as tfp
...
class EpsilonGreedyPolicy(tf_policy.TFPolicy):
  ...
  def __init__(self,
    ...
    self._random_policy = qtopt_random_policy.RandomQtoptPolicy(
  ...
  def _action(self, time_step, policy_state, seed):
    seed_stream = tfp.SeedStream(seed=seed, salt='epsilon_greedy')
